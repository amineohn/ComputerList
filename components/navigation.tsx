              ...
              {!fire.user() ? (
                <>
                  <a
                    ...
                    className="cursor-pointer group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-md text-white !bg-pink-900 !bg-opacity-20 focus:outline-none focus:!bg-pink-700 transition ease-in-out duration-150"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 512 512"
                      className="mr-4 h-5 w-5 !text-pink-100 group-hover:!text-pink-100 group-focus:!text-pink-100 transition ease-in-out duration-150"
                    >
                      <path
                        fill="currentColor"
                    ...
                    <span className="text-pink-100">Sign In</span>
                  </a>
                </>
              ) : (
                <>
